...
public class DependencyBank {
	...
	//Project plugins
	static String gwtPluginImport = "de.richsource.gradle.plugins:gwt-gradle-plugin:$gwtGradlePluginVersion";
	static String androidPluginImport = "com.android.tools.build:gradle:$androidGradlePluginVersion";
	static String roboVMPluginImport = "com.mobidevelop.robovm:robovm-gradle-plugin:$roboVMGradlePluginVersion";
	...
	public enum ProjectDependency {
		GDX(
			...
			new String[]{"com.badlogicgames.gdx:gdx-backend-gwt:$gdxVersion", "com.badlogicgames.gdx:gdx:$gdxVersion:sources", "com.badlogicgames.gdx:gdx-backend-gwt:$gdxVersion:sources", "com.bladecoder.engine:blade-engine:$bladeEngineVersion:sources", "com.bladecoder.ink:blade-ink:$bladeInkVersion:sources"},
		...
		FREETYPE(
			...
			new String[]{"com.badlogicgames.gdx:gdx-freetype-platform:$gdxVersion:natives-armeabi", "com.badlogicgames.gdx:gdx-freetype-platform:$gdxVersion:natives-armeabi-v7a", "com.badlogicgames.gdx:gdx-freetype-platform:$gdxVersion:natives-arm64-v8a", "com.badlogicgames.gdx:gdx-freetype-platform:$gdxVersion:natives-x86", "com.badlogicgames.gdx:gdx-freetype-platform:$gdxVersion:natives-x86_64"},
