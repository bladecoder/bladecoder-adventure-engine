...
public class ScnCanvas extends ApplicationAdapter {
	...
	public void create() {
		...
		Skin skin = new Skin(
				Gdx.files.internal("res/skin/HoloSkin/Holo-dark-ldpi.json"));
...
//		skin.add("background", new Texture(pixmap));
		...
		CustomList<String> l = new CustomList<String>(skin) {
			protected String getCellTitle(String item) {
				return item.toString();
			}
			
			protected String getCellSubTitle(String  item){
				return null;
			}
			
			protected Texture getCellTexture(String  item) {
				return null;
			}
		};
		...
		ScrollPane scrollPane = new ScrollPane(l, skin);
		...
		table.add(scnWidget).expand().fill();
		table.row();
